...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ResQAI — AI Disaster Response Platform" },
      {
        name: "description",
        content:
          "ResQAI is an AI-assisted disaster response console for flood, earthquake and landslide reporting, shelters and rescue coordination.",
      },
